...
apk add --no-cache gcc g++ build-base linux-headers cmake make autoconf automake libtool python3
apk add --no-cache mbedtls-dev mbedtls-static zlib-dev rapidjson-dev zlib-static pcre2-dev

git clone https://github.com/curl/curl --depth=1 --branch curl-8_10_1
cd curl
